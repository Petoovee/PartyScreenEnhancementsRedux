...
namespace PartyScreenEnhancements.ViewModel.Settings.Tabs
{
    public class SettingGeneralPaneVM : TaleWorlds.Library.ViewModel
    {
        ...
        public void AddSettingVms()
        {
            ...
            _options.Add(new BooleanOptionDataVM(_settings.UpgradeOnDone, "Automatically upgrade on close", "Automatically triggers the CTRL + Upgrade function whenever 'Done' is pressed.", (value) => _settings.UpgradeOnDone = value));
